          ...
          list: [
            {
              ...
              name: "校园设施维护与管理",
              description:
                "巡查校园内的教学楼、宿舍楼、实验室、图书馆等建筑的基础设施，包括水电系统、门窗、照明设备等，记录设施的运行状态，及时发现并安排维修损坏的设施"
            },
            {
              index: 2,
              isSetup: false,
              ...
              name: "物资采购与管理",
              description:
                "根据学校各部门的需求，制定物资采购计划，包括教学设备、办公用品、清洁用品、维修材料等，确保物资采购的及时性和合理性。"
            },
            {
              index: 3,
              isSetup: false,
              ...
              name: "餐饮服务管理",
              description:
                "监督校内食堂的日常运营，确保食堂食品安全卫生，符合国家相关标准，定期对食堂的食品原材料采购、加工过程、餐具消毒等环节进行检查"
            },
            {
              index: 4,
              isSetup: false,
              ...
              name: "保洁服务",
              description:
                "负责校园内教学楼、宿舍楼、图书馆、办公楼等场所的日常清洁工作，包括地面清扫、拖地、门窗擦拭、卫生间清洁等，保持校园环境的整洁卫生"
            },
            {
              index: 5,
              isSetup: true,
